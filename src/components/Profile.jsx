...
const userdetails = userdata?.data?.data
  ...
  return ( <> { userdetails ?(
    <div className={`  w-full font-cursive ${className} flex flex-col justify-start items-center text-white text-2xl  `}>
        <div className=' flex items-start pl-2 py-2'><img src={userdetails&&userdetails.profile_pic_url} alt="profile" className=' bg-slate-950 h-24 w-24 rounded-full' /></div>
